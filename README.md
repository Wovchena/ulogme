...
2. If you're on Ubuntu, make sure you have the dependencies: `$ sudo apt-get install xdotool xinput wmctrl gnome-screensaver`. On Fedora, you may also need `sudo yum install gnome-screensaver`.
